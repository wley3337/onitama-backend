...
#----------Movement Seeds
move1 = Move.create(x: -2,y: 2)
move2 = Move.create(x: -1,y: 2)
move3 = Move.create(x: 0,y: 2)
move4 = Move.create(x: 1,y: 2)
move5 = Move.create(x: 2,y: 2)
move6 = Move.create(x: -2,y: 1)
move7 = Move.create(x: -1,y: 1)
move8 = Move.create(x: 0,y: 1)
move9 = Move.create(x: 1,y: 1)
move10 = Move.create(x: 2,y: 1)
move11 = Move.create(x: -2,y: 0)
move12 = Move.create(x: -1,y: 0)
move13 = Move.create(x: 1,y: 0)
move14 = Move.create(x: 2,y: 0)
move15 = Move.create(x: -2,y: -1)
move16 = Move.create(x: -1,y: -1)
move17 = Move.create(x: -0,y: -1)
move18 = Move.create(x: 1,y: -1)
move19 = Move.create(x: 2,y: -1)
move20 = Move.create(x: -2,y: -2)
move21 = Move.create(x: -1,y: -2)
move22 = Move.create(x: 0,y: -2)
move23 = Move.create(x: 1,y: -2)
move24 = Move.create(x: 2,y: -2)

# ========  P L A Y E R S  ===========

p1 = Player.create(name: "red", active_player: true)
p2 = Player.create(name: "blue", active_player: false)
